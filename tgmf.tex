...
\begin{figure}[!htp]
  \centering{\includegraphics[width=9cm]{FE_model.pdf}}
...
\begin{figure*}[htbp]
  ...
  \caption{Diagram of simulated axial temperature gradients and the resulting, thermally induced axial stress components at maximum temprature (650$^{\circ}$C) during the TC-IP-TGMF test with the mechanical strain amplitude of 0.8\% (NT11: temperature in ℃, S22: axial stress in MPa, S33: hoop stress in MPa).}
  \label{Fig:FEM_result}
\end{figure*}

\begin{figure}[htbp]
  \centering{\includegraphics[width=8cm]{plot_temperature_along_gauge_length.pdf}}
