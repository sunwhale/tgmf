...
\begin{table}[htbp]
  ...
  \caption{Experimental conditions and results of thermal gradient mechanical fatigue tests.}
    ...
    \midrule
    TMF-IP \cite{SUN2019228} & 1.00 & $2.22\times 10^{-4}$ & 0   & 58 \\
          & 0.80 & $1.78\times 10^{-4}$ & 0   & 176 \\
          & 0.70 & $1.56\times 10^{-4}$ & 0   & 248 \\
          & 0.60 & $1.33\times 10^{-4}$ & 0   & 1297 \\
    \midrule
    TMF-OP \cite{SUN2019228} & 1.00 & $2.22\times 10^{-4}$ & 180 & 209 \\
          & 0.80 & $1.78\times 10^{-4}$ & 180 & 303 \\
...
The Brown-Miller's model, Fatemi-Socie's model, Smith-Watson-Topper's model, Chu-Conle-Bonnen's model, Liu's Energy model and TMF model are tried to evaluate the thermal gradient mechanical fatigue.
...
\begin{figure*}
   ...
   \begin{overpic}[width=7.0cm]{NF-NP-TGMF-Study.pdf}
     \put(50,20){\fcolorbox{white}{white}{(f) TMF}}
   \end{overpic}
...
It can be observed that the TMF model (Equation \eqref{Equ:TMF_model}) has the best agreement in the prediction of the TMF and TGMF tests.
