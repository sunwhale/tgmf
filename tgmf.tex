...
In the course of service, the turbine blades are not only subjected to the large alternating loads but also subjected to the impact of high temperature and high-pressure gas and the effect of cooling air on the surface and inside of the blades, respectively \cite{WRIGHT20073610}. So the turbine blades suffer from the thermal gradient mechanical fatigue (TGMF) damage caused by the change of load and temperature. Moreover, the temperature gradient brings about multiaxial loads to the parts. For internally cooled parts, the temperature gradient can produce additional stress, which is expressed as a multiaxial compressive load on the hotter surface, while a multiaxial tensile load is displayed on the colder surface. 

In the past, the low-cycle fatigue (LCF) test and the Manson–Coffin equation were widely used to evaluate the reliability of the substrates of gas turbine blades. However, the LCF test, which only can simulate fatigue conditions under high isothermal temperatures, cannot model actual operating conditions. For that reason, thermo-mechanical fatigue (TMF) tests, which can simulate both mechanical fatigue and thermal fatigue simultaneously, are preferred.

The nickel-base superalloy Inconel 718 is widely used in the gas turbine engines \cite{Pollock2006}. In the past decades,  the low-cycle fatigue (LCF) tests and the Manson–Coffin equation were commonly used to predict the lifetime of the gas turbine components. Numerous investigations on the elevated temperature LCF of the nickel-based superalloy were performed \cite{Koch85, Morrow88, Mahobia2014, Chen2016}. However, a number of studies showed that the thermomechanical fatigue (TMF) loading also influenced the fatigue damage mechanisms significantly. For different phases between the cyclic mechanical loading and temperature, the TMF lifetime can be shorter or longer than the isothermal one \cite{Evans2008, Bauer2009, LEE201462, Kulawinski2015, SCHLESINGER2017242, DENG2019813, SUN2019228}. However, the TMF test, which can simulate both mechanical fatigue and thermal fatigue simultaneously, cannot investigate the temperature gradient effect. 

Few works on the temperature gradient effect and TGMF fatigue life were published. Brendel et al. \cite{BRENDEL2008234} and Prasad et al. \cite{PRASAD2013131} investigated temperature gradients in TMF specimens. The results showed that the temperature gradients had a remarkable influence on the TMF lifetime. Baufeld et al. \cite{BAUFELD2008219} and Bartsch et al. \cite{BARTSCH2008211} carried out the thermal gradient mechanical fatigue testing for the single-crystalline superalloy CMSX-4 with a NiPtAl oxidation protection coating. Microstructural changes, defects, phase evolution of the metal coatings and rafting of the $\gamma$/$\gamma'$ substrate morphology were investigated. They detected the cracks at the inner specimen surface and substrate pores. 

However, the assessment of the TGMF lifetime has been rarely reported. In this study, the thin-walled tubular specimen is used to simulate the influence of the temperature gradient. Under the action of the internal cooling air, a temperature gradient between the inner surface and the outer surface of the component was produced. The thermal gradients cause multiaxial loads in the specimen, and the thermal gradient induced stresses cannot be relaxed by macroscopic deformations. The stresses occurring at the specimen lead to multiaxial pressure loads on the outer surface and multiaxial tensile loads on the inner surface. The TGMF test is the most appropriate experiment to simulate the actual loading conditions of gas turbine engines in the laboratory, and the research was necessary to understand the damage mechanism of the turbine blades and discs. 

In the experiment, the conventional induction heating equipment only heated the inner metal layer, which is not conducive to the generation of the temperature gradient between the outer and inner surface of the specimen. Therefore, a radiation heating system was developed for the TGMF testing. However, there are many obstacles to TGMF lifetime assessment, such as the determination of temperature and local stress-strain evolution of the specimen during the TGMF testing. Sun \cite{SUN2019228} introduced a plasticity modeling of nickel-based superalloy Inconel 718 under multiaxial thermomechanical fatigue loading conditions. The constitutive law was used to determine the local stress and strain response during the TGMF testing. In the study, comparing the TMF \cite{SUN201989} and TGMF experimental results, the thermal gradient effect on the fatigue lifetime was investigated.
...
\subsection{Specimen}
In order to enhance the engine cooling effect and improve the engine efficiency, most of the advanced gas turbine blades are thin-walled porous structures. Therefore, thin-walled tubular specimens were designed to simulate the cooling structure of the parts. The geometry of the specimen is shown in \autoref{Fig:IN718_Axial_Specimen_TGMF}, 120 mm in the total length, a gauge length of 30 mm, an outer diameter of the gauge section of 8.5 mm and an inner diameter of the specimen of 6.5 mm. Thus, the wall thickness of the tubular specimen in the gauge section is 1 mm. All specimens were manufactured by a CNC machining center, and the surfaces were polished before testing. 
...
\begin{figure*}[htbp]
  \centering{\includegraphics[width=14cm]{FEM_result.jpg}}
...
\begin{figure*}[htbp]
  \centering{\includegraphics[width=16cm]{Fractography.jpg}}
...
In Equation (\ref{Equ:A}), $Q$ presents \cite{Warren2006,Warren2008}
\begin{equation}
...
\begin{figure*}
   ...
   \begin{overpic}[width=7.0cm]{NF-NP-TGMF-Study.pdf}
     \put(7教育部留学服务中心0,20){\fcolorbox{white}{white}{(f) TMF}}
   \end{overpic}
